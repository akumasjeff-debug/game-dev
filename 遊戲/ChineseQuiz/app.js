...
const CHAR_FILL_Q = [
  ...
  { before:'這個故事真的好有（　）。', zhuyin:'ㄑㄩˋ', answer:'趣', options:['趣','取','去','娶'] },
  { before:'棉花糖（　）的很甜。', zhuyin:'ㄓㄣ', answer:'真', options:['真','針','珍','貞'] },
  { before:'妹妹喜歡（　）繩，真好玩。', zhuyin:'ㄊㄧㄠˋ', answer:'跳', options:['跳','眺','挑','逃'] },
];
